        ...
        <div className="relative" onClick={(e) => e.stopPropagation()}>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-40">
              {isAuthor && (
                <>
                  <DropdownMenuItem onClick={(e) => {
                    e.preventDefault(); // Keep menu interaction clean
                    handleEdit(e);
                  }}>
              ...
              <DropdownMenuItem onClick={(e) => {
                e.preventDefault(); // Prevent menu closing immediately if we want to show toast? No, close is fine.
                handleReport(e);
              }}>
            ...
            <Button
              onClick={async () => {
                ...
                try {
                  ...
                  // Removed manual invalidation to avoid race conditions with Realtime subscription
                  // queryClient.invalidateQueries({ queryKey: ["posts"] });
