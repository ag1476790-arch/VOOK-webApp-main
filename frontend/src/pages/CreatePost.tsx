...
const CreatePost = () => {
    ...
    const handlePost = async () => {
        if (!content.trim() && selectedImageFiles.length === 0 && !isPollActive && selectedDocs.length === 0) return;
        ...
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-border/50">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        disabled={(!content.trim() && selectedImageFiles.length === 0 && !isPollActive && selectedDocs.length === 0) || isPosting}
                        onClick={handlePost}
